...
InvalidEntry = -1
KartInfo = enum.IntEnum("KartInfo", ("name", "model", "cost", "viewDist", "decalId", "LODmodel1", "LODmodel2"), start=0)
AccInfo =  enum.IntEnum("AccInfo", ("name", "model", "cost", "texCard," "attach"), start=0)
##########################################################################
